...
export const PaymentPreview: React.FC<PaymentPreviewProps> = ({ data }) => {
    return (
        <div className="mt-2 -mx-1 rounded-xl overflow-hidden border border-black/5 dark:border-white/5 bg-[#F4F2EC] dark:bg-[#182329]">
            <div className="px-3 py-2.5 flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                    <p className="text-[0.8125rem] font-semibold text-[#111B21] dark:text-[#E9EDEF] leading-tight truncate">
                        {data.title}
                    </p>
                    <p className="text-[0.6875rem] text-[#667781] dark:text-[#8696A0] leading-tight mt-0.5 truncate">
                        {data.subtitle}
                    </p>
                </div>
            </div>
            {data.cta && (
                <div className="px-3 py-2 border-t border-black/5 dark:border-white/5 bg-white dark:bg-[#202C33] flex items-center justify-between">
